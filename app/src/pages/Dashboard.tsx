  ...
  return (
    <div className="max-w-[1440px] mx-auto animate-fade-in">
      ...
      <div className="mb-8">
        ...
        <p className="text-[#555555]">Welcome back{user?.name ? `, ${user.name}` : ''}. Here&apos;s what&apos;s happening today.</p>
      </div>
          ...
          >
            <div className="flex items-start justify-between">
              ...
              <div className={`p-2 rounded-lg ${
                stat.trend === 'up' ? 'bg-[#E8F5E9]' : 
                stat.trend === 'down' ? 'bg-[#FFEBEE]' : 
                'bg-[#E5F6FC]'
              }`}>
                <stat.icon className={`w-5 h-5 ${
                  stat.trend === 'up' ? 'text-[#3BB54A]' : 
            ...
            <div className="flex items-start justify-between mb-4">
              ...
              {module.badge && (
                <span className={`px-2.5 py-1 rounded-full text-xs font-semibold ${
                  module.badge.type === 'error' ? 'bg-[#FFEBEE] text-[#E53935]' :
